...
router.get('/', auth_middleware_1.authMiddleware, recipe_controller_1.getRecipes);
router.get('/:id', auth_middleware_1.authMiddleware, recipe_controller_1.getRecipeById);
